...
- [x] 型定義の変更 (`NospaceTypes.ts`)
- [x] Store の変更 (`optionsAtom.ts`)
- [x] UI コンポーネントの変更 (`ExecutionOptions.tsx`)
- [x] Hook の変更 (`useNospaceExecution.ts`)
- [x] Backend の変更 (`WasmExecutionBackend.ts`)
- [x] スタイルの調整
- [x] テストの更新・追加
- [x] ビルド・全テスト合格 (204 tests)
