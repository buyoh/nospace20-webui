...
- `CompileOptions.stdExtensions`: ✅ 実装済み
- `CompileOptions.optPasses`: ❌ 未実装
- `ExecutionOptions.optPasses`: ❌ 未実装
- `compileOptionsAtom.optPasses`: ❌ 未実装
- `executionOptionsAtom.optPasses`: ❌ 未実装
