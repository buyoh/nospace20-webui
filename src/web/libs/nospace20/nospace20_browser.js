...
exports.WasmWhitespaceVM = WasmWhitespaceVM;
 ...
 * @returns {any}
 */
function compile(source, target, lang_std) {
 ...
 * @returns {any}
 */
function compile_to_mnemonic_string(source) {
    const ptr0 = passStringToWasm0(source, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.compile_to_mnemonic_string(ptr0, len0);
    return ret;
}
exports.compile_to_mnemonic_string = compile_to_mnemonic_string;
 ...
 * @returns {any}
 */
function compile_to_whitespace_string(source) {
    const ptr0 = passStringToWasm0(source, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.compile_to_whitespace_string(ptr0, len0);
    return ret;
}
exports.compile_to_whitespace_string = compile_to_whitespace_string;
 ...
 * @returns {any}
 */
function run(source, stdin, debug) {
    const ptr0 = passStringToWasm0(source, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(stdin, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
...
// This file is a modified version of nospace20.js for browser environments.
// The original uses Node.js fs.readFileSync, which is replaced with fetch here.
// When updating nospace20.js from wasm-bindgen, reapply this modification.
...
export { WasmWhitespaceVM, compile, compile_to_mnemonic_string, compile_to_whitespace_string, parse, run, init };
